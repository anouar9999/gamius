...
const MatchCard = () => {
  ...
  <Link  href={'match/5'}>
    <div
      ...
      className="bg-[#222327] rounded-lg text-white w-full max-w-sm sm:max-w-md mx-auto"
    >
      <MatchCardHeader />
          ...
          <div className="flex justify-between items-center mb-4">
            <div className="w-[45%] flex items-center">
              <div className="flex-grow">
                <p className="text-gray-400 text-xs text-right">Team A</p>
                <p className="text-white text-xs font-semibold text-right">FORETOX EZR</p>
              </div>
              <img
                ...
                alt="Team A"
                className="w-8 h-8 sm:w-10 sm:h-10 rounded-md ml-2 sm:ml-3"
              />
            </div>

            <div className="text-white text-lg sm:text-2xl font-bold mx-2">VS</div>
            ...
            <div className="w-[45%] flex items-center justify-end">
              ...
              <div className="text-right flex-grow">
                <p className="text-gray-400 text-xs text-left">Team B</p>
                <p className="text-white text-xs font-semibold text-left">RUBBITS RUSH</p>
              </div>
            </div>
          </div>
